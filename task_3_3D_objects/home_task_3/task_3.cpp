...
//    glDepthFunc(GL_LESS);
    ...
    GLuint programID_1 = LoadShaders("SimpleVertexShader.vertexshader",
                                     "SimpleFragmentShader_1.fragmentshader");
    GLuint programID_2 = LoadShaders("SimpleVertexShader.vertexshader",
                                     "SimpleFragmentShader_2.fragmentshader");
    ...
    const double PI_2_Coef = 2 * glm::pi<double>() / TICKS_PER_ROTATION;
